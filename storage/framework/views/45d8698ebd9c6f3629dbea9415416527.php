            ...
            <div class="col-12 col-xl-12">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Get Quality Check Report</h5>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive-xxl">
                                    ...
                                    <form method="GET" action="<?php echo e(route('karigar.qualitycheck.report')); ?>" id="dateForm">
                                        <div class="row g-3">
                                            <!-- Date From -->
                                            <div class="col-md-3">
...
<?php /**PATH E:\webdev\Pritamjewellery\resources\views/transaction-reports/quality-check.blade.php ENDPATH**/ ?>