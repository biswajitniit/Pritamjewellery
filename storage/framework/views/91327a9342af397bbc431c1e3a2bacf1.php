    ...
    <div class="offcanvas-body p-0">
        <div class="order-list">
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/01.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/02.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/03.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/04.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/05.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/06.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/07.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
            ...
            <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                <div class="order-img">
                    <img src="<?php echo e(asset('assets/images/orders/08.png')); ?>" class="img-fluid rounded-3" width="75" alt="">
                </div>
                <div class="order-info flex-grow-1">
...
<script src="<?php echo e(asset('assets/plugins/metismenu/metisMenu.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/plugins/simplebar/js/simplebar.min.js')); ?>"></script>
<script src="<?php echo e(asset('assets/js/main.js')); ?>"></script>
<script src="<?php echo e(asset('assets/extrajs/sweetalert2@11.js')); ?>"></script>
<script>
   ...
   /* $('#SelectAllStockoutPdiList').click(function () {
    ...
    function Deleteproductstone(productstoneid){
        ...
        if (result.isConfirmed) {
                // GET Item Header
                $.ajax({
                    url: "<?php echo e(route('deleteproductstone')); ?>",
                    type: "POST",
                    //dataType: 'json',
                    data:{productstoneid:productstoneid, _token: '<?php echo e(csrf_token()); ?>'},
    ...
    $("document").ready(function(){
        $('#item_code_product').keyup(function() {
            ...
            if($itemcode.length == 2){
                // GET Item Header
                $.ajax({
                    url: "<?php echo e(route('getitemheaderdescription')); ?>",
                    type: "POST",
                    dataType: 'json',
                    data:{headercode:$itemcode.substr(0,2), _token: '<?php echo e(csrf_token()); ?>'},
                    success: function (result) {
            ...
            if($itemcode.length == 7){
                // GET Pcode
                $.ajax({
                    url: "<?php echo e(route('getpcode')); ?>",
                    type: "POST",
                    dataType: 'json',
                    data:{code:$itemcode.substr(6,7), _token: '<?php echo e(csrf_token()); ?>'},
                    success: function (result) {
            ...
            if($itemcode.length == 10){
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: 'json',
                    data:{schar:$itemcode.substr(9,10), _token: '<?php echo e(csrf_token()); ?>'},
                    success: function (result) {
                        if(result.ssize == ''){
...
unset($__errorArgs, $__bag); ?>
    ...
    $(".add_more_product_stone_items").click(function () {
        ...
        ?>
        newRowAdd = '<div id="row" class="row g-3 mb-3"><div class="col-md-2"><select name="stone_type[]" class="form-select rounded-0 <?php $__errorArgs = ['item_code'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" required><option value="">Choose...</option><?php $__empty_1 = true; $__currentLoopData = $stones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><option value="<?php echo e($stone->id); ?>"><?php echo e($stone->description); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?> <?php endif; ?></select><?php $__errorArgs = ['customer_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?></div><div class="col-md-2"><select name="category[]" id="category_'+$counter+'" class="form-select rounded-0"><option value="">Choose...</option><option value="stone">Stone</option><option value="miscellaneous">Miscellaneous</option></select></div><div class="col-md-1"><input type="text" name="pcs[]" id="pcs_'+$counter+'" value="" class="form-control rounded-0" /></div><div class="col-md-2"><input type="text" name="weight[]" id="weight_'+$counter+'" value="" class="form-control rounded-0" /></div><div class="col-md-1"><input type="text" name="rate[]" id="rate_'+$counter+'" value="" class="form-control rounded-0"></div><div class="col-md-2"><input type="text" name="amount[]" id="amount_'+$counter+'" value="" class="form-control rounded-0"></div><div class="col-md-2"><button class="btn btn-danger" id="DeleteRow" type="button"><i class="bi bi-trash"></i>Delete</button></div></div>';
    ...
    function Get_product_info(itemval,countid){
        $.ajax({
            url: "<?php echo e(route('getproductinfo')); ?>",
            type: "POST",
            dataType: 'json',
            data:{itemval:itemval, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function Get_order_info(customerid){
        $.ajax({
            url: "<?php echo e(route('getorderno')); ?>",
            type: "POST",
            //dataType: 'json',
    ...
    function Get_order_items(customerorderid){
        $.ajax({
            ...
            type: "POST",
            //dataType: 'json',
            data:{order_id:customerorderid, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetCustomerDetails(customerid){
        $.ajax({
            url: "<?php echo e(route('getcustomerdetails')); ?>",
            type: "POST",
            dataType: 'json',
            data:{customerid:customerid, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetMetalPurity(metal_id){
        $.ajax({
            url: "<?php echo e(route('getmetalpurity')); ?>",
            type: "POST",
            //dataType: 'json',
            data:{metal_id:metal_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetMetalPurityDistinct(metal_id){
        $.ajax({
            url: "<?php echo e(route('getmetalpuritydistinct')); ?>",
            type: "POST",
            //dataType: 'json',
            data:{metal_id:metal_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function Get_issue_to_karigar_items(kid){
        $.ajax({
            url: "<?php echo e(route('getissuetokarigaritems')); ?>",
            type: "POST",
            dataType: 'json',
            data:{kid:kid, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
        ...
        $.ajax({
            url: "<?php echo e(route('getkarigardetailsissuetokarigaritems')); ?>",
            type: "POST",
            dataType: 'json',
            data:{kid:kid, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetKarigarDetails(karigar_id){
        $.ajax({
            url: "<?php echo e(route('getkarigardetails')); ?>",
            type: "POST",
            dataType: 'json',
            data:{karigar_id:karigar_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
                $("#karigar_name").attr('value',result.kname);
            }
        })
    ...
    function GetIssueToKarigarItemDetails(karigar_id){
        $.ajax({
            url: "<?php echo e(route('getissuetokarigaritemdetails')); ?>",
            type: "POST",
            //dataType: 'json',
            data:{karigar_id:karigar_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetItemCodeDeatils(item_code){
        $.ajax({
            url: "<?php echo e(route('getissuetokarigaritemcodedetails')); ?>",
            type: "POST",
            dataType: 'json',
            data:{item_code:item_code, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function Get_metal_issue_category(metal_category){
        ...
        $.ajax({
            url: "<?php echo e(route('getmetalname')); ?>",
            type: "POST",
            //dataType: 'json',
            data:{metal_category:metal_category, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetMetalPurityMetalIssue(metal_id){
        ...
        $.ajax({
            url: "<?php echo e(route('getmetalpuritymetalissue')); ?>",
            type: "POST",
            //dataType: 'json',
            data:{metal_id:metal_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
    ...
    function GetMetalPurityInfo(purity_id){
        ...
        $.ajax({
            url: "<?php echo e(route('getmetalpurityinfo')); ?>",
            type: "POST",
            dataType: 'json',
            data:{purity_id:purity_id, _token: '<?php echo e(csrf_token()); ?>'},
            success: function (result) {
                //$("#purity_id").html(result);
    ...
    function GetTotalMetalReceiveWeight(){
        ...
        if (metal_id !== '' && purity_id !== '') {
            $.ajax({
                url: "<?php echo e(route('gettotalmetalreceiveweight')); ?>",
                type: 'POST',
                data: {
                    metal_id: metal_id,
                    purity_id: purity_id,
    ...
    $(document).ready(function() {
        ...
        $('#receive_qty').on('input', function() {
            ...
            $.ajax({
                url: "<?php echo e(route('getNextSlno')); ?>",
                type: "POST",
                data: {
    ...
    function GetLocationWiseVoucherNo(location_id,voucher_type){
        if (location_id !== '' && voucher_type !== '') {
            $.ajax({
                url: "<?php echo e(route('getlocationwisevoucherno')); ?>",
                type: 'POST',
                data: {
    ...
    function GetSizePcodeWise(pcode_id) {
        if (pcode_id !== '') {
            $.ajax({
                url: "<?php echo e(route('getsizepcodewise')); ?>",
                type: "POST",
                //dataType: "json",
                data: {
    ...
    function Getjoborderno(select){
        ...
        if (jobNo !== '') {
            $.ajax({
                url: "<?php echo e(route('getordertype')); ?>",
                type: "POST",
                dataType: "json",
                data: {
    ...
    function GetItemList(itemname) {
        if (itemname) {
            $.ajax({
                url: "<?php echo e(route('getitemlist')); ?>",
                type: "POST",
                data: {
                    itemname: itemname,
                    _token: "<?php echo e(csrf_token()); ?>"
    ...
    function GetItemListIssueToKarigar(itemname) {
        if (itemname) {
            $.ajax({
                url: "<?php echo e(route('getitemlistissuetokarigar')); ?>",
                type: "POST",
                data: {
                    itemname: itemname,
                    _token: "<?php echo e(csrf_token()); ?>"
    ...
    function GetHtmlMetalIssueToKarigar(value) {
        ...
        if (itemType === 'Metal' && itemName.toUpperCase() === 'GOLD') {
            ...
            $.ajax({
                url: "<?php echo e(route('getmetalpuritygroup')); ?>",
                type: "POST",
                data: {
                    item: 1, // 1 for gold
                    _token: "<?php echo e(csrf_token()); ?>"
            ...
            $.ajax({
                url: "<?php echo e(route('getmetalpuritylist')); ?>",
                type: "POST",
                data: {
                    _token: "<?php echo e(csrf_token()); ?>"
                },
    ...
    function GetLocationWiseStockEffectItemName(location_name) {
        if (location_name !== '') {
            $.ajax({
                url: "<?php echo e(route('getlocationwisestockeffectitemname')); ?>",
                type: 'POST',
                data: {
    ...
    function setStockAvailable(metalNameVal) {
        ...
        $.ajax({
            url: "<?php echo e(route('getstockavailable')); ?>",
            type: 'POST',
            data: {
    ...
    function GetToLocation(location_name){
        if (location_name !== '') {
            $.ajax({
                url: "<?php echo e(route('gettolocation')); ?>",
                type: 'POST',
                data: {
                    location_name: location_name,
                    _token: '<?php echo e(csrf_token()); ?>'
    ...
    let oldKid = "<?php echo e($old_karigar_id ?? ''); ?>";
    let oldItemCode = "<?php echo e($old_item_code ?? ''); ?>";
    ...
    function GetKIDjobnowise(job_no) {
        if (job_no !== '') {
            $.ajax({
                url: "<?php echo e(route('getkidjobnowise')); ?>",
                type: "POST",
                data: {
                    job_no: job_no, 
                    _token: "<?php echo e(csrf_token()); ?>"
    ...
    function GetItemCodeKIDJobNoWise(kid) {
        ...
        if (kid !== '' && job_no !== '') {
            $.ajax({
                url: "<?php echo e(route('getitemcodekidjobnowise')); ?>",
                type: "POST",
                data: {
                    kid: kid,
                    job_no: job_no, 
    ...
    function GetItemCodeKIDJobNoWiseQtyGrosswtNetwt(item_code) {
        ...
        if (item_code !== '' && job_no !== '' && kid !== '') {
            ...
            $.ajax({
                url: "<?php echo e(route('getitemcodekidjobnowiseqtygrosswtnetwt')); ?>",
                type: "POST",
                data: {
                    item_code: item_code,
                    job_no: job_no,
    ...
    function loadItemCodeByKid(karigar_id) {
        ...
        $.ajax({
            url: "<?php echo e(route('qc.getItemCodes')); ?>",
            type: "POST",
            data: {
    ...
    function fetchBarcodeData(barcode) {
        ...
        $.ajax({
            url: "<?php echo e(route('get.barcode.data')); ?>",
            type: "GET",
...
<?php /**PATH E:\webdev\Pritamjewellery\resources\views/include/footer.blade.php ENDPATH**/ ?>