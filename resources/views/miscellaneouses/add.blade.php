            ...
            <div class="col-12 col-xl-6 offset-xl-3">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Miscellaneous <div class="style_back"> <a href="{{ route('miscellaneouses.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('miscellaneouses.store') }}" method="POST" name="saveStones">
                            @csrf

                            <div class="col-md-4">
                                <label class="form-label">Product Code <span style="color: red">*</span></label>
                                <input type="text" name="product_code" value="{{ old('product_code') }}" class="form-control rounded-0 text-end @error('product_code') is-invalid @enderror" required/>
                                @error('product_code')
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="product_name" value="{{ old('product_name') }}" class="form-control rounded-0 text-end @error('product_name') is-invalid @enderror" required/>
                                @error('product_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
