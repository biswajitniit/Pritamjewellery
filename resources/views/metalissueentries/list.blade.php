          ...
          <div class="col-12 col-xl-12">
            <div class="card border-top border-3 border-danger rounded-0">
              <div class="card-header py-3 px-4">
                <h5 class="mb-0 text-danger">Metal Issue Entry
                </h5>
                <div id="fixed-social">
                                              ...
                                              <tr>
                                                <td><div class="dropdown dd__">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="{{ route('metalissueentries.edit',[$metalissueentrie->metal_issue_entries_id]) }}"><i class="fa fa-pencil"></i> Edit</a></li>
                                                    <li><hr class="dropdown-divider"></hr></li>
                                                    <li><a class="dropdown-item" href="{{ route('metalissueentries.show',[$metalissueentrie->metal_issue_entries_id]) }}"><i class="fa fa-print"></i> Print </a></li>
                                                    <li><hr class="dropdown-divider"></hr></li>
                                                    <li>
                                                  ...
                                                  <td>
                                                    @foreach($metalissueentrie->karigar as $karigars)
                                                        {{ $karigars->kid }}
                                                    @endforeach
                                                  </td>
                                                  <td>
                                                    @foreach($metalissueentrie->metal as $metals)
                                                        {{ $metals->metal_name }}
                                                    @endforeach
                                                  </td>
                                                  <td>
                                                    @foreach($metalissueentrie->metalpurity as $metalpuritys)
                                                        {{ $metalpuritys->purity }}
                                                    @endforeach
                                                  </td>
