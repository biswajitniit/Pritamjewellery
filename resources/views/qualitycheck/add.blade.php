            ...
            <div class="col-12">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Quality Check <div class="style_back"> <a href="{{ route('qualitychecks.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('qualitychecks.store') }}" method="POST" name="savequalitychecks">
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="location_id" class="form-select rounded-0 @error('location_id') is-invalid @enderror" onchange="GetLocationWiseVoucherNo(this.value,'quality_check')">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="qc_voucher" id="voucher_no" value="" class="form-control rounded-0 text-end  @error('qc_voucher') is-invalid @enderror" />
                                @error('qc_voucher')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            {{-- <div class="col-md-1">
                                <a href="#"><img src="assets/images/3796706_9644.jpg" class="img-thumbnail" alt="" /></a>
                            </div> --}}
