            ...
            <div class="col-12 col-xl-8 offset-xl-2">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Party <div class="style_back"> <a href="{{ route('customers.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('customers.store') }}" method="POST" name="saveCustomers">
                            @csrf
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="border p-2">
                                    <div class="form-check-inline">
                                        <label class="form-check-label"> <input type="radio" class="form-check-input me-2" checked name="party_type" value="Customer" required/>Customer </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label"> <input type="radio" class="form-check-input me-2" name="party_type" value="Company" required/>Company </label>
                                    </div>
                                </div>
                            </div>
