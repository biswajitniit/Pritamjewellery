            ...
            <div class="col-12 col-xl-8 offset-xl-2">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Edit Party <div class="style_back"> <a href="{{ route('customers.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('customers.update', [$customers->id]) }}" method="POST" name="editCustomers">
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="border p-2">
                                    <div class="form-check-inline">
                                        <label class="form-check-label"> <input type="radio" class="form-check-input me-2" checked name="party_type" value="Customer" @if($customers->party_type == 'Customer') checked @endif required/>Customer </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label"> <input type="radio" class="form-check-input me-2" name="party_type" value="Company" @if($customers->party_type == 'Company') checked @endif required/>Company </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="cid" value="{{ @$customers->cid }}" class="form-control rounded-0 @error('cid') is-invalid @enderror" required/>
                                @error('cid')
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="cust_name" value="{{ @$customers->cust_name }}" class="form-control rounded-0 @error('cust_name') is-invalid @enderror" required/>
                                @error('cust_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="cust_code" value="{{ old('cust_code', @$customers->cust_code) }}" class="form-control rounded-0"/>
                            </div>
                            <div class="col-md-12">
                                <label class="form-label">Address <span style="color: red">*</span></label>
                                <input type="text" name="address" value="{{ @$customers->address }}" class="form-control rounded-0 @error('address') is-invalid @enderror" required/>
                                @error('address')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="city" value="{{ @$customers->city }}" class="form-control rounded-0 @error('city') is-invalid @enderror" required/>
                                @error('city')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="state" value="{{ @$customers->state }}" class="form-control rounded-0 @error('state') is-invalid @enderror" required/>
                                @error('state')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="cont_person" value="{{ @$customers->cont_person }}" class="form-control rounded-0 @error('cont_person') is-invalid @enderror" required/>
                                @error('cont_person')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="statecode" value="{{ @$customers->statecode }}" class="form-control rounded-0 text-end @error('statecode') is-invalid @enderror" required/>
                                @error('statecode')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
