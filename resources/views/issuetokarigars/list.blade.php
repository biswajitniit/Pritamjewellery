                                              ...
                                              <tr>
                                                <td>
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{ route('issuetokarigars.view',[$issuetokarigar->jo_no, $issuetokarigar->kid, $issuetokarigar->issue_to_karigar_id]) }}"><i class="fa fa-eye"></i> View</a></li>
                                                        <li><hr class="dropdown-divider"></hr></li>
                                                        <li><a class="dropdown-item" href="{{ route('issuetokarigars.print',[$issuetokarigar->jo_no, $issuetokarigar->kid, $issuetokarigar->issue_to_karigar_id]) }}"><i class="fa fa-print"></i> Print </a></li>
                                                    </ul>
                                                    </div>
                                                </td>
                                                  <td scope="row">{{ $count }}</td>
                                                  <td>
                                                    {{ $issuetokarigar->jo_no }}
                                                  </td>
                                                  <td>
                                                    {{ date('Y-m-d',strtotime($issuetokarigar->jo_date)) }}
                                                  </td>
                                                  <td>
                                                    {{ $issuetokarigar->kid }}
                                                  </td>
                                                  <td>
                                                    {{ $issuetokarigar->kname }}
                                                  </td>
