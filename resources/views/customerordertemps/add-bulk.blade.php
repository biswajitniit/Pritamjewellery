            ...
            <div class="col-12">
                <div class="card border-top border-3 border-danger rounded-0 trans_">
                    <div class="card-header py-3 px-4">
                        ...
                        <h5 class="mb-0 text-danger">Add Customer Order Temp Bulk
                            <div class="style_back"> <a href="{{ route('customerordertemps.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div>
                        </h5>
                    </div>
