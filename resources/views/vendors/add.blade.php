            ...
            <div class="col-12 col-xl-8 offset-xl-2">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Vendor <div class="style_back"> <a href="{{ route('vendors.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('vendors.store') }}" method="POST" name="saveVendor">
                            @csrf

                            <div class="col-md-5">
                                <label class="form-label">VID <span style="color: red">*</span></label>
                                <input type="text" name="vid" value="{{ old('vid') }}" class="form-control rounded-0 @error('vid') is-invalid @enderror" required/>
                                @error('vid')
                            ...
                            <div class="col-md-5">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control rounded-0 @error('name') is-invalid @enderror" required/>
                                @error('name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="vendor_code" value="{{ old('vendor_code') }}" class="form-control rounded-0"/>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="contact_person" value="{{ old('contact_person') }}" class="form-control rounded-0 @error('contact_person') is-invalid @enderror" required/>
