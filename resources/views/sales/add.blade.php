            ...
            <div class="col-12 col-xl-8 offset-xl-2">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Sale <div class="style_back"> <a href="{{ route('sales.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                            ...
                            <div class="col-md-5">
                                ...
                                <select name="customer" class="form-select rounded-0 @error('customer') is-invalid @enderror" required>
                                    ...
                                    @foreach ($customers as $customer)
                                        <option value="{{ $customer->id }}">{{ $customer->cust_name }} - {{ $customer->cust_code }}</option>
                                    @endforeach
                                </select>
                                @error('customer')
