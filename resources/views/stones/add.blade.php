            ...
            <div class="col-12 col-xl-6 offset-xl-3">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Stone <div class="style_back"> <a href="{{ route('stones.index') }}"><i class="fa fa-chevron-left"></i> Back </a></div></h5>
                    </div>
                    ...
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('stones.store') }}" method="POST" name="saveStones">
                            @csrf

                            <div class="col-md-4">
                                <label class="form-label">Additional Charge ID <span style="color: red">*</span></label>
                                <input type="text" name="additional_charge_id" value="{{ old('additional_charge_id') }}" class="form-control rounded-0 text-end @error('additional_charge_id') is-invalid @enderror" required/>
