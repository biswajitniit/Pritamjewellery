<table>
    <thead>
        ...
        <tr>
            <th colspan="8" style="text-align: center; font-size: 14px; font-weight: bold; padding: 10px;">
                {{ $company_name }}
            </th>
        </tr>
        ...
        {{-- Row 2: Subtitle - BOLD --}}
        <tr>
            <th colspan="8" style="text-align: center; font-size: 11px; font-weight: bold; padding: 8px;">
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="8" style="text-align: center; border: 1px solid #000; padding: 10px;">No records found</td>
        </tr>
        @endforelse
    </tbody>
</table>
