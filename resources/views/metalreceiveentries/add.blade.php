            ...
            <div class="col-12 col-xl-8 offset-xl-2">
                <div class="card border-top border-3 border-danger rounded-0">
                    <div class="card-header py-3 px-4">
                        <h5 class="mb-0 text-danger">Add Metal Receive Entry <div class="style_back"> <a
                        ...
                        <div class="card-body p-4">
                            <form class="row g-3" action="{{ route('metalreceiveentries.store') }}" method="POST"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="vou_no" id="voucher_no" value="{{ old('vou_no') }}"
                                        class="form-control rounded-0 @error('vou_no') is-invalid @enderror" readonly />
                                    @error('vou_no')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="customer_id"
                                        class="form-select rounded-0 @error('customer_id') is-invalid @enderror"
                                        onchange="GetCustomerDetails(this.value)">
                                        <option value="">Choose...</option>
                                        @forelse($customers as $customer)
                                        <option value="{{ $customer->id }}">{{ $customer->cust_name }}
                                            ({{ $customer->cid }})
                                        </option>
                                        @empty
                                        @endforelse
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input type="text" name="cust_name" id="cust_name" value="{{ old('cust_name') }}"
                                        class="form-control rounded-0 @error('cust_name') is-invalid @enderror"
                                        readonly />
                                    @error('cust_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                ...
                                <!--    <textarea name="cust_address" id="cust_address"
                                    class="form-control rounded-0 @error('cust_address') is-invalid @enderror" readonly>{{ old('cust_address') }}</textarea>-->
                                <!--    @error('cust_address')
    -->
                                <!--        <span class="invalid-feedback" role="alert">-->
                                <!--            <strong>{{ $message }}</strong>-->
...
@enderror-->
                                ...
                                <select name="item_type" class="form-select rounded-0 @error('item_type') is-invalid @enderror">
                                    <option value="">Choose...</option>
                                    ...
                                    <option value="Misscl">Misscl</option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="item_type" class="form-select rounded-0" id="item_type"
                                onchange="GetItemList(this.value)" required="">
                                <option value="">Choose...</option>
                    ...
                    {{-- <div class="col-md-3">
                                ...
                                <select name="metal_id" id="metal_id"
                                    class="form-select rounded-0 @error('metal_id') is-invalid @enderror"
                                    onchange="GetMetalPurity(this.value)" required>
                                    <option value="">Choose...</option>
                                </select>
                                @error('metal_id')
                                    <span class="invalid-feedback" role="alert">
                ...
                <div class="col-md-5">
                    ...
                    <select name="item" class="form-select rounded-0" id="itemlist" onchange="GetHtml(this.value)"
                        required="">
                        <option value="">Choose...</option>
                    </select>
                </div>
