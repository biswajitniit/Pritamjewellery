...
<body>
    ...
    <header class="top-header">
      <nav
        class="navbar navbar-expand align-items-center justify-content-between gap-4 border-bottom">
            ...
            <div class="offcanvas offcanvas-start w-260" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header border-bottom h-70">
                    <div class="d-flex align-items-center gap-2">
                        <div class>
                            <img src="{{ asset('assets/images/logo-icon.png') }}" class="logo-icon" width="45" alt="logo icon" />
                        </div>
                        <div class>
                ...
                <div class="offcanvas-body p-0">
                    <ul class="navbar-nav align-items-center flex-grow-1 navbar_">
                        ...
                        @if(Auth::user()->id == 1) <!-- For access only super admin -->
                        <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                @foreach ($menus as $route => $label)
                                    @php
                                        $permission = getUserMenuPermission(Auth::user()->id, $route, 'menu_permissions');
                                    @endphp
                            ...
                            <ul class="dropdown-menu">
                                <li class="nav-item dropend">
                                    ...
                                    <ul class="dropdown-menu submenu">
                                        ...
                                        @php
                                            $permission_customerorders = getUserMenuPermission(Auth::user()->id, 'customerorders', 'menu_permissions');
                                        @endphp
                                        ...
                                        @php
                                            $permission_issuetokarigars = getUserMenuPermission(Auth::user()->id, 'issuetokarigars', 'menu_permissions');
                                        @endphp
                                ...
                                <li class="nav-item dropend">
                                    ...
                                    <ul class="dropdown-menu submenu">
                                        <li>
                                            <a class="dropdown-item" href="{{ route('metalissueentries.index') }}"> Gold Issue To Karigar </a>
                                        </li>
                                        <li>
