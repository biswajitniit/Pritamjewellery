...
<script>
   ...
   /* $('#SelectAllStockoutPdiList').click(function () {
    ...
    function calculateTotals() {
        ...
        $('.stockoutpdilist:checked').each(function () {
            let values = $(this).val().split(',');
            let qty = parseFloat(values[0]) || 0;  // receive_qty
            let wt = parseFloat(values[1]) || 0;   // net_wt
            total += qty;
            totalwt += wt;
        });
            ...
            const html = `
                <div class="col-md-2">
                    ...
                    <select name="purity_id" id="purity_id"
                            ...
                            onchange="GetMetalPurityInfo(this.value)" required>
                        <option value="">Choose...</option>
                    </select>
                </div>

                // <div class="col-md-2">
                //     <label class="form-label" style="font-size: .85rem;">Convert Purity <span class="text-danger">*</span></label>
                //     <input type="text" name="converted_purity" id="converted_purity"
                ...
                <div class="col-md-2">
                    ...
                    <input type="text" name="weight" id="weight"
                        ...
                        onkeyup="GetAlloyandNetWeight(); GetTotalMetalReceiveWeight();" required/>
                </div>
