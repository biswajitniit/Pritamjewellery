            ...
            <div class="col-12">
                ...
                @endif
                    <div class="card-body p-4">
                        <form class="row g-3" action="{{ route('finishproductreceivedentries.store') }}" method="POST" name="saveFinishproductreceivedentries" id="saveFinishproductreceivedentries">
                            @csrf
                            <div class="row m-2">
                                <div class="col-md-2">
