          ...
          <div class="col-12 col-xl-12">
            <div class="card border-top border-3 border-danger rounded-0">
              <div class="card-header py-3 px-4">
                <h5 class="mb-0 text-danger">Uom Master
                </h5>
                <div id="fixed-social">
                  ...
                  <div>
                      <a href="{{ route('uoms.create') }}">ADD</a>
                  </div>
                  @endif
                                              ...
                                              <tr>
                                                <td><div class="dropdown dd__">
                                                  ...
                                                  <ul class="dropdown-menu">
                                                    ...
                                                    @php
                                                        $permission_edit = getUserMenuPermission(Auth::user()->id, 'uoms', 'permissions_edit');
                                                    @endphp
                                                    @if ($permission_edit && $permission_edit->permissions_edit == 1)
                                                        <li><a class="dropdown-item" href="{{ route('uoms.edit',[$uom->id]) }}"><i class="fa fa-pencil"></i> Edit</a></li>
                                                    @endif

                                                    <li><hr class="dropdown-divider"></hr></li>

                                                    @php
                                                        $permission_delete = getUserMenuPermission(Auth::user()->id, 'uoms', 'permissions_delete');
                                                    @endphp
